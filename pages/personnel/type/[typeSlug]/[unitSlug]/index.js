...
export default function PersonnelName({unit,type}) {
  ...
  return (
    <div className='p-2'>
      ...
      <motion.main  className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 py-4  mt-10 mb-20 container mx-auto'>
    {personnel.data && 
    personnel.data.map(item=>{
        return  <motion.div key={item.id} variants={sectionAnimation} initial="hidden" animate="visible"  whileHover="hover"   className='bg-primary-light-green drop-shadow-lg p-2 rounded-md'>
