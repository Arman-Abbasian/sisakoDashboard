...
export default function Press({data}) {
  ...
  return (
    <div className='p-2'>
      ...
      {data.map(item=>(
        <motion.div variants={sectionAnimation} initial="hidden" animate="visible" whileHover="hover"  className='bg-primary-light-green drop-shadow-lg p-2 rounded-md' key={item.id}>
          <Link href={`die/${item.customer}`} legacyBehavior><a className='w-full'>
            <div className='grid grid-cols-2  gap-4'>
              ...
              <div className='flex  justify-center items-center'>
                <h1 className='font-bold text-xl'>{item.customer}</h1>
              </div>
            </div>
            </a></Link>
      </motion.div>
